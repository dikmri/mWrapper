...
PHRASE_TRANSLATIONS = (
    ...
    ("NSFW_MMaudio model already exists", "NSFW_MMaudioモデルはすでに存在します"),
    ("Downloading NSFW_MMaudio model", "NSFW_MMaudioモデルをダウンロードしています"),
    ("NSFW_MMaudio download progress", "NSFW_MMaudioダウンロード進捗"),
    ("NSFW_MMaudio model installed", "NSFW_MMaudioモデルをインストールしました"),
